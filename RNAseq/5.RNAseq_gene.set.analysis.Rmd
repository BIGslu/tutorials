...
Note that if you read this csv back into R, the `genes` column will not be formatting correctly for downstream our package functions. Thus, we recommend saving data in `.RData` or `.Rds` in order to maintain formatting.
